...
export default function ClassicTemplate({ data }: { data: ResumeData }) {
  ...
  const fontFamily = customization?.fontFamily || "Georgia, serif";
  const fontSize = customization?.fontSize === "sm" ? "13px" : customization?.fontSize === "lg" ? "15px" : "14px";
  const headingSize = customization?.fontSize === "sm" ? "17px" : customization?.fontSize === "lg" ? "21px" : "19px";
      ...
      case "summary":
        ...
        return (
          <section key="summary" className="mb-5">
            <h2
              className="font-bold border-b pb-1 mb-2 tracking-wide uppercase"
      ...
      case "experience":
        ...
        return (
          <section key="experience" className="mb-5">
            <h2
              className="font-bold border-b pb-1 mb-3 tracking-wide uppercase"
              style={{ color: accentColor, borderColor: accentColor, fontSize: headingSize }}
            >
              Experience
            </h2>
                ...
                <div key={proj.id}>
                  <div className="flex justify-between items-baseline flex-wrap">
                    <h3 className="font-bold text-slate-900">
                      {proj.title}
                      {proj.link && (
                        <span className="font-normal text-xs text-blue-700 ml-2 underline">
                          {proj.link}
                        </span>
                      )}
                    </h3>
      ...
      case "certifications":
        ...
        return (
          <section key="certifications" className="mb-5">
            ...
            <ul className="list-disc list-outside ml-4 text-slate-700 text-sm space-y-1">
  ...
  return (
    ...
    >
      {/* Centered Header */}
      <header className="text-center border-b pb-5 mb-5 border-slate-300">
        <h1 className="font-bold tracking-tight text-slate-900 mb-1" style={{ fontSize: nameSize }}>
        ...
        <div className="flex justify-center items-center flex-wrap gap-x-3 gap-y-1 text-xs text-slate-600">
